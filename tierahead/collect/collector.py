...
point checks tierahead.hw.probe() first.
...
class Collector:
    ...
    def _hook_factory(self, layer_idx: int):
        ...
        from tierahead.collect.hooks import softmax_entropy
...
def main(argv=None):
    ...
    if not caps.can_collect_traces:
        print(
            "tierahead collect: refusing to run -- this machine cannot collect real traces "
    ...
    from tierahead.collect.prompts import build_workload, save_prompt_list
