...
of ``tierahead.sim.engine``'s general N-class fluid DES instead of its own
...
No GPU, no model weights: expert traffic reuses tierahead.roofline's
...
from tierahead.roofline.model import bytes_per_layer, build_e_union_lookup, get_t_compute_ms
from tierahead.sim.engine import TrafficClass, pareto_labels, pctile_stats, pooled_simulate
