...
from tierahead.traces.io import explode_topk, expert_counts, load_traces, load_req_order, train_test_split_reqs
...
def run_characterization(trace_dir: Path, b8_dir: Path | None = None, seed: int = 0,
    ...
    `tierahead analyze` and the baseline-vs-CXL comparison both call."""
