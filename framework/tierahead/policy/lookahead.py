...
tierahead.roofline's compute-time model) and always importable. The
...
def train_ids_d1_models(decode_df, train_reqs, n_experts, n_layers, hidden_dim, epochs, seed):
    ...
    from tierahead.policy import features as feat
    from tierahead.policy import predictor_mlp as mlpmod
